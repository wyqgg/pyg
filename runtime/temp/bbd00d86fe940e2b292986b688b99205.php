<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:79:"/www/wwwroot/pyg/public/../application/admin/view/brand/product-brand-edit.html";i:1563183012;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<title>修改品牌 - 商品管理 - H-ui.admin v3.0</title>
</head>
<body>
	...
	<input type="hidden" name="id" value="<?php echo $info['id']; ?>">
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $info['name']; ?>" placeholder="" id="name" name="name" datatype="*2-16" nullmsg="品牌名称不能为空">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red">*</span>品牌分类：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $info['category']['cate_name']; ?>" placeholder="" id="" name="" disabled>
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3"><span class="c-red"></span>修改品牌分类：</label>
			<div class="formControls col-xs-8 col-sm-9">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $info['desc']; ?>" placeholder="" id="desc" name="desc" datatype="*2-16" nullmsg="">
			</div>
		</div>
		<div class="row cl">
			<label class="form-label col-xs-4 col-sm-3">排序：</label>
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" value="<?php echo $info['sort']; ?>" placeholder="" id="sort" name="sort" datatype="*2-16" nullmsg="">
			</div>
		</div>
		<div class="row cl">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9 ">
				<div class="radio-box">
					<input name="is_hot" type="radio" id="nav-1" value="1" <?php if(($info['is_hot'] == 1)): ?>checked<?php endif; ?>>
					<label for="nav-1">是</label>
				</div>
				<div class="radio-box">
					<input name="is_hot" type="radio" id="nav-2" value="0" <?php if(($info['is_hot'] == 0)): ?>checked<?php endif; ?>>
