<?php if (!defined('THINK_PATH')) exit(); /*a:2:{s:67:"/www/wwwroot/pyg/public/../application/home/view/order/myOrder.html";i:1619203119;s:50:"/www/wwwroot/pyg/application/home/view/layout.html";i:1619203727;}*/ ?>
<!DOCTYPE html>
<html>
<head>
    <meta charset="utf-8" />
						...
						<div class="ever">
							...
							<div class="tab-content">
								<div class="chosetype">
								      	...
								      	<a role="button" href="javascript:void(0);">全部状态 </a>
</span></span>
														</th>
													</tr>
												</thead>
                                    ...
                                    <?php foreach($lists as $k=>$v): ?>
										<table class="sui-table table-bordered">
											<thead>
												<tr>
													<th colspan="5">
														<span class="ordertitle">订单编号：<?php echo $v['order_sn']; ?> <span class="pull-right delete"></span>
													</th>
												</tr>
											</thead>
											<tbody>
												<tr>
													<td width="40%">
														<div class="typographic"><img src="<?php echo $v['goods_logo']; ?>" />
															<a href="#" class="block-text"><?php echo $v['goods_price']; ?></a><span>x1</span>
														</div>
													</td>
													<td rowspan="2" width="8%" class="center"><?php echo $v['consignee']; ?></td>
													<td rowspan="2" width="13%" class="center">
														<ul class="unstyled">
															<li>总金额¥<?php echo $v['order_amount']; ?></li>
															<li>在线支付</li>
													...
													<td rowspan="2" width="8%" class="center">
														...
														<a href="#" class="btn">未付款 </a>
														  <?php elseif($v['order_status'] == 1): ?>
														  	<a href="#" class="btn">待发货 </a>
														  	<?php elseif($v['order_status'] == 2): ?>
														  	<a href="#" class="btn">待收货 </a>
