<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:70:"/www/wwwroot/pyg/public/../application/admin/view/admin/admin-add.html";i:1617782250;}*/ ?>
﻿<!--_meta 作为公共模版分离出去-->
<!DOCTYPE HTML>
<html>
<head>
...
<article class="cl pd-20">
	<form action="<?php echo url('save'); ?>" method="post" class="form form-horizontal" id="form-add">
		...
		<div class="row cl">
			...
			<div class="formControls col-xs-8 col-sm-9">
				<input type="text" class="input-text" autocomplete="off" value="123456" placeholder="密码" id="password" name="password">
			</div>
		</div>
		<div class="row cl">
