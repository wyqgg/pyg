<?php if (!defined('THINK_PATH')) exit(); /*a:1:{s:85:"/www/wwwroot/pyg/public/../application/admin/view/category/product-category-edit.html";i:1563183010;}*/ ?>
<!DOCTYPE HTML>
<html>
<head>
	<meta charset="utf-8">
		...
		<form action="<?php echo url('update'); ?>" method="post" class="form form-horizontal" id="form-add">
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<input type="text" class="input-text" value="<?php echo $info['cate_name']; ?>" placeholder="" name="cate_name">
				</div>
			</div>
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9">
					<span class="select-box" style="width:150px;">
						<select name="pid" class="select" size="1">
							...
							<option value="<?php echo $v['id']; ?>" <?php if(($v['id'] == $info['pid'])): ?>selected="selected"<?php endif; ?>><?php echo str_repeat('&emsp;', $v['level']*2); ?><?php echo $v['cate_name']; ?></option>
							<?php endforeach; ?>
						</select>
					</span>
				</div>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9 ">
					<div class="radio-box">
						<input name="is_hot" type="radio" id="hot-1" value="1" <?php if(($info['is_hot'] == '是')): ?>checked<?php endif; ?>>
						<label for="hot-1">是</label>
					</div>
					<div class="radio-box">
						<input name="is_hot" type="radio" id="hot-2" value="0" <?php if(($info['is_hot'] == '否')): ?>checked<?php endif; ?>>
			...
			<div class="row cl">
				...
				<div class="formControls col-xs-8 col-sm-9 ">
					<div class="radio-box">
						<input name="is_show" type="radio" id="show-1" value="1" <?php if(($info['is_show'] == '是')): ?>checked<?php endif; ?>>
						<label for="show-1">是</label>
					</div>
					<div class="radio-box">
						<input name="is_show" type="radio" id="show-2" value="0" <?php if(($info['is_show'] == '否')): ?>checked<?php endif; ?>>
