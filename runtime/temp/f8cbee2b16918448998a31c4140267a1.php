...
<section class="Hui-article-box">
	...
	<div class="Hui-article">
		<article class="cl pd-20">
			<div class="text-l">
				<div>订单编号：<?php echo $order['order_sn']; ?></div>
				<div>用户id：<?php echo $order['user_id']; ?></div>
				<div>用户昵称：<?php echo $order['user']['nickname']; ?></div>
				<div>订单应付金额：<?php echo $order['order_amount']; ?></div>
